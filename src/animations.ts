...
export const animations: AnimationConfig[] = [
  ...
  {
    id: "laplacianFractalAdvection",
    name: "Laplacian Fractal Advection",
    description:
      "A Mandelbox fractal surface perturbs turbulent volumetric smoke via advected FBM, with vivid IQ-palette lighting and forward-scatter glow.",
    ...
    params: [
      ...
      },
      {
        ...
        max: 3.0,
        step: 0.01,
        key: { inc: "u", dec: "j", step: 0.1, shiftStep: 0.3 },
      },
      {
        id: "advectionRate",
        label: "Advection Rate",
        uniform: "uAdvectionRate",
        type: "float",
        value: 0.8,
        min: 0.0,
        max: 3.0,
