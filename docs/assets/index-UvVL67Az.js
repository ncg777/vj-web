...
`;const k=document.querySelector("#gl-canvas"),ee=document.querySelector("#scene-list"),nt=document.querySelector("#control-list"),Fe=document.querySelector("#panel-actions"),le=document.querySelector("#key-help"),Ue=document.querySelector("#hud-title"),Zt=document.querySelector("#hud-desc"),Le=document.querySelector("[data-action='toggle-sidebar']"),yt=document.querySelector(".stage");if(!k||!ee||!nt||!Fe||!le||!Ue||!Zt||!Le||!yt)throw new Error("Missing required UI elements");const s=k.getContext("webgl2",{antialias:!0});if(!s)throw yt.innerHTML=`
  ...
  `,new Error("WebGL2 unavailable");const qi=s.getExtension("EXT_color_buffer_float"),Hi=!!qi;s.disable(s.DEPTH_TEST);s.disable(s.BLEND);const At=Dn(s),Yt=new Map,Kt={},oe={},Qt={},it=new Map;for(const e of ve){const t=En(s,mn,e.fragment),n=new Set;n.add(e.resolutionUniform),n.add(e.timeUniform),e.loopUniform&&n.add(e.loopUniform),e.stateful&&(n.add(e.passUniform??"uPass"),n.add(e.stateUniform??"uState"),n.add(e.gridUniform??"uGridSize"));for(const l of e.params)n.add(l.uniform);const o=Mn(s,t,Array.from(n));Yt.set(e.id,{program:t,uniforms:o});const a={},r={};for(const l of e.params)a[l.id]=l,r[l.id]=l.type==="seed"?Math.floor(Math.random()*1e6):l.value;Kt[e.id]=a,oe[e.id]={...r},Qt[e.id]={...r}}let W=ve[0],ot={},gt=performance.now(),He=null,Ve=null,X=null,we=[],Jt=0,ze=null,ge=!1;function Vi(){const e=["video/webm;codecs=vp9","video/webm;codecs=vp8","video/webm","video/mp4"];for(const t of e)if(MediaRecorder.isTypeSupported(t))return t;return""}function ji(e){return e.startsWith("video/mp4")?"mp4":"webm"}function Xi(e){const t=Math.floor(e/1e3),n=String(Math.floor(t/60)).padStart(2,"0"),o=String(t%60).padStart(2,"0");return`${n}:${o}`}function $i(){const e=document.getElementById("rec-badge");!e||!ge||(e.textContent=`⏺ ${Xi(performance.now()-Jt)}`)}function Zi(){const e=Vi();if(!e){alert("Recording is not supported in this browser.");return}const t=k.captureStream(60);we=[],X=new MediaRecorder(t,{mimeType:e,videoBitsPerSecond:16e6}),X.ondataavailable=n=>{n.data.size>0&&we.push(n.data)},X.onstop=()=>{const n=ji(e),o=new Blob(we,{type:e}),a=URL.createObjectURL(o),r=document.createElement("a");r.href=a,r.download=`${W.id}-${Date.now()}.${n}`,r.click(),URL.revokeObjectURL(a),we=[]},X.start(500),ge=!0,Jt=performance.now(),en(),ze=window.setInterval($i,250)}function Yi(){X&&X.state!=="inactive"&&X.stop(),ge=!1,ze!==null&&(clearInterval(ze),ze=null),en()}function Ki(){ge?Yi():Zi()}function en(){const e=document.getElementById("rec-btn"),t=document.getElementById("rec-badge");!e||!t||(ge?(e.textContent="Stop",e.classList.add("recording"),t.classList.remove("hidden")):(e.textContent="Record",e.classList.remove("recording"),t.classList.add("hidden"),t.textContent=""))}let Ge=!1;function at(e){Le.classList.toggle("hidden",e)}function Qi(){at(!1),Ve!==null&&window.clearTimeout(Ve),Ve=window.setTimeout(()=>{at(!0)},2500)}function tn(){const e=document.body.classList.contains("sidebar-collapsed");Le.textContent=e?">>":"<<"}function Ji(){var e;(e=Ue.parentElement)==null||e.classList.remove("hidden"),He!==null&&window.clearTimeout(He),He=window.setTimeout(()=>{var t;(t=Ue.parentElement)==null||t.classList.add("hidden")},1e4)}function Ft(e){const t=s.createTexture();if(!t)throw new Error("Failed to create state texture");return s.bindTexture(s.TEXTURE_2D,t),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.REPEAT),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.REPEAT),s.texImage2D(s.TEXTURE_2D,0,s.RGBA16F,e,e,0,s.RGBA,s.HALF_FLOAT,null),s.bindTexture(s.TEXTURE_2D,null),t}function eo(e){const t=Ft(e),n=Ft(e),o=s.createFramebuffer(),a=s.createFramebuffer();if(!o||!a)throw new Error("Failed to create framebuffer");return s.bindFramebuffer(s.FRAMEBUFFER,o),s.framebufferTexture2D(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,t,0),s.bindFramebuffer(s.FRAMEBUFFER,a),s.framebufferTexture2D(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,n,0),s.bindFramebuffer(s.FRAMEBUFFER,null),{size:e,textures:[t,n],fbos:[o,a],index:0,needsInit:!0}}function bt(e){if(!e.stateful)return null;let t=it.get(e.id);const n=e.bufferSize??192;return(!t||t.size!==n)&&(t=eo(n),it.set(e.id,t)),t}function pe(e){const t=it.get(e);t&&(t.needsInit=!0)}function to(e,t){let n=t;return e.min!==void 0&&(n=Math.max(e.min,n)),e.max!==void 0&&(n=Math.min(e.max,n)),e.type==="int"&&(n=Math.round(n)),n}function nn(e,t){if(e.type==="int")return String(Math.round(t));const n=e.step??.01,o=n<1?Math.min(4,Math.max(2,Math.ceil(-Math.log10(n)))):0;return t.toFixed(o)}function no(e){return e.length===1?e.toLowerCase():e}function io(e){return e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement||e instanceof HTMLSelectElement}function he(e,t,n,o=!0){const a=Kt[e][t];if(!a)return;const r=to(a,n);if(oe[e][t]=r,e===W.id&&o){const l=ot[t];l!=null&&l.range&&(l.range.value=String(r)),l!=null&&l.number&&(l.number.value=nn(a,r))}}function oo(e){var t;for(const n of((t=ve.find(o=>o.id===e))==null?void 0:t.params)??[])n.type==="seed"&&he(e,n.id,Math.floor(Math.random()*1e6));pe(e)}function ao(e){const t=Qt[e];for(const[n,o]of Object.entries(t))he(e,n,o,!0);pe(e)}function ro(){ee.innerHTML="";for(const e of ve){const t=document.createElement("option");t.value=e.id,t.textContent=e.name,ee.appendChild(t)}ee.addEventListener("change",()=>{on(ee.value)})}function lo(e){Fe.innerHTML="";const t=document.createElement("button");if(t.className="ghost small",t.textContent="Reset",t.addEventListener("click",()=>ao(e.id)),Fe.appendChild(t),e.params.some(o=>o.type==="seed")){const o=document.createElement("button");o.className="ghost small",o.textContent="Reseed",o.addEventListener("click",()=>oo(e.id)),Fe.appendChild(o)}}function so(e){nt.innerHTML="",ot={};for(const t of e.params){if(t.type==="seed")continue;const n=document.createElement("div");n.className="control";const o=document.createElement("div");o.className="control-header";const a=document.createElement("label");if(a.textContent=t.label,o.appendChild(a),t.key){const d=document.createElement("span");d.className="key-cap",d.textContent=`${t.key.inc.toUpperCase()}/${t.key.dec.toUpperCase()}`,o.appendChild(d)}const r=document.createElement("div");r.className="control-inputs";const l=document.createElement("input");l.type="range",l.min=String(t.min??0),l.max=String(t.max??1),l.step=String(t.step??(t.type==="int"?1:.01)),l.value=String(oe[e.id][t.id]),l.addEventListener("input",d=>{const y=Number(d.target.value);Number.isNaN(y)||he(e.id,t.id,y)});const u=document.createElement("input");u.type="number",u.min=l.min,u.max=l.max,u.step=l.step,u.value=nn(t,oe[e.id][t.id]),u.addEventListener("input",d=>{const y=Number(d.target.value);Number.isNaN(y)||he(e.id,t.id,y)}),r.appendChild(l),r.appendChild(u),n.appendChild(o),n.appendChild(r),nt.appendChild(n),ot[t.id]={range:l,number:u}}}function uo(e){le.innerHTML="";for(const t of e.params){if(!t.key||t.type==="seed")continue;const n=document.createElement("div");n.className="key-row",n.textContent=`${t.key.inc.toUpperCase()}/${t.key.dec.toUpperCase()}  ${t.label}`,le.appendChild(n)}le.childElementCount||(le.textContent="No mapped keys for this scene.")}function on(e){const t=ve.find(n=>n.id===e);t&&(W=t,t.stateful&&(bt(t),pe(t.id)),Ue.textContent=t.name,Zt.textContent=t.description,Ji(),lo(t),so(t),uo(t),ee.value=t.id)}function fo(e){if(io(e.target))return;const t=no(e.key),n=W.params;for(const o of n){if(!o.key||o.type==="seed")continue;const a=t===o.key.inc,r=t===o.key.dec;if(!a&&!r)continue;const l=e.shiftKey&&o.key.shiftStep?o.key.shiftStep:o.key.step,d=oe[W.id][o.id]+l*(a?1:-1);he(W.id,o.id,d),e.preventDefault();break}}function Ce(e,t,n,o,a){const r=oe[e.id],l=t.uniforms,u=l[e.resolutionUniform];u&&s.uniform2f(u,o,a);const d=l[e.timeUniform];if(d)if(e.timeMode==="phase"){const g=e.loopDuration??8,w=n%g/g;s.uniform1f(d,w)}else if(e.timeMode==="looped"){const g=e.loopDuration??8,w=n%g;if(s.uniform1f(d,w),e.loopUniform){const S=l[e.loopUniform];S&&s.uniform1f(S,g)}}else s.uniform1f(d,n);const y={};for(const g of e.params){const w=l[g.uniform],S=r[g.id];if(g.component!==void 0){const O=y[g.uniform]??[0,0,0];O[g.component]=S,y[g.uniform]=O;continue}w&&(g.type==="int"?s.uniform1i(w,Math.round(S)):s.uniform1f(w,S))}for(const[g,w]of Object.entries(y)){const S=l[g];S&&s.uniform3f(S,w[0],w[1],w[2])}}function je(e,t,n,o){const a=t.uniforms[e.passUniform??"uPass"];a&&s.uniform1i(a,o);const r=t.uniforms[e.gridUniform??"uGridSize"];r&&s.uniform2f(r,n.size,n.size);const l=t.uniforms[e.stateUniform??"uState"];l&&s.uniform1i(l,0)}function an(e,t,n,o){const a=Yt.get(e.id);if(a){if(e.stateful){if(!Hi)return;const r=bt(e);if(!r)return;const l=()=>r.textures[r.index],u=()=>r.fbos[(r.index+1)%2];s.useProgram(a.program),s.bindVertexArray(At),r.needsInit&&(s.bindFramebuffer(s.FRAMEBUFFER,u()),s.viewport(0,0,r.size,r.size),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,l()),Ce(e,a,t,n,o),je(e,a,r,2),s.drawArrays(s.TRIANGLES,0,3),r.index=(r.index+1)%2,r.needsInit=!1),s.bindFramebuffer(s.FRAMEBUFFER,u()),s.viewport(0,0,r.size,r.size),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,l()),Ce(e,a,t,n,o),je(e,a,r,0),s.drawArrays(s.TRIANGLES,0,3),r.index=(r.index+1)%2,s.bindFramebuffer(s.FRAMEBUFFER,null),s.viewport(0,0,n,o),s.clearColor(0,0,0,1),s.clear(s.COLOR_BUFFER_BIT),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,l()),Ce(e,a,t,n,o),je(e,a,r,1),s.drawArrays(s.TRIANGLES,0,3);return}s.viewport(0,0,n,o),s.clearColor(0,0,0,1),s.clear(s.COLOR_BUFFER_BIT),s.useProgram(a.program),s.bindVertexArray(At),Ce(e,a,t,n,o),s.drawArrays(s.TRIANGLES,0,3)}}function St(e){if(Ge)return;const t=(e-gt)/1e3,{width:n,height:o}=Pn(k);an(W,t,n,o),requestAnimationFrame(St)}function co(){return new Promise(e=>requestAnimationFrame(()=>e()))}async function mo(e,t,n,o,a){if(typeof VideoEncoder>"u"||typeof VideoFrame>"u"){alert("Offline rendering requires the WebCodecs API (Chrome/Edge 94+, Safari 16.4+).");return}const r={codec:"avc1.640028",width:o,height:a,bitrate:16e6,framerate:n};if(!(await VideoEncoder.isConfigSupported(r)).supported){alert("H.264 video encoding is not supported on this device.");return}let u;try{u=await window.showSaveFilePicker({suggestedName:`${e.id}-${o}x${a}-${n}fps-${t}s.mp4`,types:[{description:"MP4 Video",accept:{"video/mp4":[".mp4"]}}]})}catch{return}const d=await u.createWritable(),y=document.getElementById("offline-btn"),g=document.getElementById("offline-progress"),w=document.getElementById("offline-bar"),S=document.getElementById("offline-status");y&&(y.disabled=!0),g==null||g.classList.remove("hidden"),S==null||S.classList.remove("hidden"),Ge=!0,e.stateful&&(bt(e),pe(e.id));const O=k.width,G=k.height,M=k.style.width,Y=k.style.height;k.width=o,k.height=a,k.style.width=`${o}px`,k.style.height=`${a}px`;const rn=new Gt(d),xt=new Oi({target:rn,video:{codec:"avc",width:o,height:a},fastStart:!1});let be=null;const K=new VideoEncoder({output:(C,Oe)=>xt.addVideoChunk(C,Oe??void 0),error:C=>{be=C}});K.configure(r);const Se=Math.ceil(t*n),wt=Math.round(1e6/n),ln=n*2,sn=n*30,un=performance.now();let xe=!1;const Ct=C=>{C.preventDefault(),xe=!0};k.addEventListener("webglcontextlost",Ct);for(let C=0;C<Se&&!(be||xe);C++){const Oe=C/n;an(e,Oe,o,a),s.finish();const Tt=new VideoFrame(k,{timestamp:C*wt,duration:wt});K.encode(Tt,{keyFrame:C%ln===0}),Tt.close(),C>0&&C%sn===0&&await K.flush();const fn=(C+1)/Se*100;if(w&&(w.style.width=`${fn}%`),C%30===0){const cn=(performance.now()-un)/1e3/(C+1)*(Se-C-1);S&&(S.textContent=`Frame ${C+1}/${Se}  —  ~${Math.ceil(cn)}s left`)}K.encodeQueueSize>10&&await new Promise(kt=>setTimeout(kt,1)),await co()}k.removeEventListener("webglcontextlost",Ct);try{await K.flush(),K.close(),xt.finalize(),await d.close()}catch(C){console.error("Finalization failed:",C);try{await d.close()}catch{}}k.style.width=M,k.style.height=Y,k.width=O,k.height=G,e.stateful&&pe(e.id),Ge=!1,gt=performance.now(),requestAnimationFrame(St),y&&(y.disabled=!1);const We=be?be.message:null;S&&(xe?S.textContent="Context lost — partial video saved.":We?S.textContent=`Error: ${We}`:S.textContent="Done!"),setTimeout(()=>{g==null||g.classList.add("hidden"),S==null||S.classList.add("hidden"),w&&(w.style.width="0%")},xe||!!We?8e3:3e3)}Le.addEventListener("click",()=>{document.body.classList.toggle("sidebar-collapsed"),tn()});yt.addEventListener("mousemove",()=>{Qi()});document.addEventListener("keydown",fo);document.addEventListener("visibilitychange",()=>{document.hidden||(gt=performance.now())});var zt;(zt=document.getElementById("rec-btn"))==null||zt.addEventListener("click",Ki);var It;(It=document.getElementById("offline-btn"))==null||It.addEventListener("click",()=>{if(Ge)return;const e=document.getElementById("offline-duration"),t=document.getElementById("offline-fps"),n=document.getElementById("offline-res"),o=Math.max(1,Math.min(3600,Number((e==null?void 0:e.value)??10))),a=Number((t==null?void 0:t.value)??60),[r,l]=((n==null?void 0:n.value)??"1920x1080").split("x").map(Number);mo(W,o,a,r,l)});ro();on(W.id);tn();at(!0);requestAnimationFrame(St);
