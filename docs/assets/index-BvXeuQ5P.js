...
`;const k=document.querySelector("#gl-canvas"),ee=document.querySelector("#scene-list"),nt=document.querySelector("#control-list"),Fe=document.querySelector("#panel-actions"),le=document.querySelector("#key-help"),Ue=document.querySelector("#hud-title"),Yt=document.querySelector("#hud-desc"),Le=document.querySelector("[data-action='toggle-sidebar']"),yt=document.querySelector(".stage");if(!k||!ee||!nt||!Fe||!le||!Ue||!Yt||!Le||!yt)throw new Error("Missing required UI elements");const s=k.getContext("webgl2",{antialias:!0});if(!s)throw yt.innerHTML=`
    <div class="fallback">
      <h2>WebGL2 unavailable</h2>
      <p>Your browser or GPU does not expose WebGL2. Try a different browser.</p>
    </div>
  `,new Error("WebGL2 unavailable");const ji=s.getExtension("EXT_color_buffer_float"),Xi=!!ji;s.disable(s.DEPTH_TEST);s.disable(s.BLEND);const Bt=Gn(s),Zt=new Map,Kt={},oe={},Qt={},it=new Map;for(const e of ve){const t=Pn(s,mn,e.fragment),n=new Set;n.add(e.resolutionUniform),n.add(e.timeUniform),e.loopUniform&&n.add(e.loopUniform),e.stateful&&(n.add(e.passUniform??"uPass"),n.add(e.stateUniform??"uState"),n.add(e.gridUniform??"uGridSize"));for(const l of e.params)n.add(l.uniform);const o=Nn(s,t,Array.from(n));Zt.set(e.id,{program:t,uniforms:o});const a={},r={};for(const l of e.params)a[l.id]=l,r[l.id]=l.type==="seed"?Math.floor(Math.random()*1e6):l.value;Kt[e.id]=a,oe[e.id]={...r},Qt[e.id]={...r}}let O=ve[0],ot={},gt=performance.now(),qe=null,Ve=null,X=null,we=[],Jt=0,ze=null,ge=!1;function $i(){const e=["video/webm;codecs=vp9","video/webm;codecs=vp8","video/webm","video/mp4"];for(const t of e)if(MediaRecorder.isTypeSupported(t))return t;return""}function Yi(e){return e.startsWith("video/mp4")?"mp4":"webm"}function Zi(e){const t=Math.floor(e/1e3),n=String(Math.floor(t/60)).padStart(2,"0"),o=String(t%60).padStart(2,"0");return`${n}:${o}`}function Ki(){const e=document.getElementById("rec-badge");!e||!ge||(e.textContent=`⏺ ${Zi(performance.now()-Jt)}`)}function Qi(){const e=$i();if(!e){alert("Recording is not supported in this browser.");return}const t=k.captureStream(60);we=[],X=new MediaRecorder(t,{mimeType:e,videoBitsPerSecond:16e6}),X.ondataavailable=n=>{n.data.size>0&&we.push(n.data)},X.onstop=()=>{const n=Yi(e),o=new Blob(we,{type:e}),a=URL.createObjectURL(o),r=document.createElement("a");r.href=a,r.download=`${O.id}-${Date.now()}.${n}`,r.click(),URL.revokeObjectURL(a),we=[]},X.start(500),ge=!0,Jt=performance.now(),en(),ze=window.setInterval(Ki,250)}function Ji(){X&&X.state!=="inactive"&&X.stop(),ge=!1,ze!==null&&(clearInterval(ze),ze=null),en()}function eo(){ge?Ji():Qi()}function en(){const e=document.getElementById("rec-btn"),t=document.getElementById("rec-badge");!e||!t||(ge?(e.textContent="Stop",e.classList.add("recording"),t.classList.remove("hidden")):(e.textContent="Record",e.classList.remove("recording"),t.classList.add("hidden"),t.textContent=""))}let Ge=!1;function at(e){Le.classList.toggle("hidden",e)}function to(){at(!1),Ve!==null&&window.clearTimeout(Ve),Ve=window.setTimeout(()=>{at(!0)},2500)}function tn(){const e=document.body.classList.contains("sidebar-collapsed");Le.textContent=e?">>":"<<"}function no(){var e;(e=Ue.parentElement)==null||e.classList.remove("hidden"),qe!==null&&window.clearTimeout(qe),qe=window.setTimeout(()=>{var t;(t=Ue.parentElement)==null||t.classList.add("hidden")},1e4)}function Ft(e){const t=s.createTexture();if(!t)throw new Error("Failed to create state texture");return s.bindTexture(s.TEXTURE_2D,t),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.REPEAT),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.REPEAT),s.texImage2D(s.TEXTURE_2D,0,s.RGBA16F,e,e,0,s.RGBA,s.HALF_FLOAT,null),s.bindTexture(s.TEXTURE_2D,null),t}function io(e){const t=Ft(e),n=Ft(e),o=s.createFramebuffer(),a=s.createFramebuffer();if(!o||!a)throw new Error("Failed to create framebuffer");return s.bindFramebuffer(s.FRAMEBUFFER,o),s.framebufferTexture2D(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,t,0),s.bindFramebuffer(s.FRAMEBUFFER,a),s.framebufferTexture2D(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,n,0),s.bindFramebuffer(s.FRAMEBUFFER,null),{size:e,textures:[t,n],fbos:[o,a],index:0,needsInit:!0}}function bt(e){if(!e.stateful)return null;let t=it.get(e.id);const n=e.bufferSize??192;return(!t||t.size!==n)&&(t=io(n),it.set(e.id,t)),t}function de(e){const t=it.get(e);t&&(t.needsInit=!0)}function oo(e,t){let n=t;return e.min!==void 0&&(n=Math.max(e.min,n)),e.max!==void 0&&(n=Math.min(e.max,n)),e.type==="int"&&(n=Math.round(n)),n}function nn(e,t){if(e.type==="int")return String(Math.round(t));const n=e.step??.01,o=n<1?Math.min(4,Math.max(2,Math.ceil(-Math.log10(n)))):0;return t.toFixed(o)}function ao(e){return e.length===1?e.toLowerCase():e}function ro(e){return e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement||e instanceof HTMLSelectElement}function he(e,t,n,o=!0){const a=Kt[e][t];if(!a)return;const r=oo(a,n);if(oe[e][t]=r,e===O.id&&o){const l=ot[t];l!=null&&l.range&&(l.range.value=String(r)),l!=null&&l.number&&(l.number.value=nn(a,r))}}function lo(e){var t;for(const n of((t=ve.find(o=>o.id===e))==null?void 0:t.params)??[])n.type==="seed"&&he(e,n.id,Math.floor(Math.random()*1e6));de(e)}function so(e){const t=Qt[e];for(const[n,o]of Object.entries(t))he(e,n,o,!0);de(e)}function uo(){ee.innerHTML="";for(const e of ve){const t=document.createElement("option");t.value=e.id,t.textContent=e.name,ee.appendChild(t)}ee.addEventListener("change",()=>{on(ee.value)})}function fo(e){Fe.innerHTML="";const t=document.createElement("button");if(t.className="ghost small",t.textContent="Reset",t.addEventListener("click",()=>so(e.id)),Fe.appendChild(t),e.params.some(o=>o.type==="seed")){const o=document.createElement("button");o.className="ghost small",o.textContent="Reseed",o.addEventListener("click",()=>lo(e.id)),Fe.appendChild(o)}}function co(e){nt.innerHTML="",ot={};for(const t of e.params){if(t.type==="seed")continue;const n=document.createElement("div");n.className="control";const o=document.createElement("div");o.className="control-header";const a=document.createElement("label");if(a.textContent=t.label,o.appendChild(a),t.key){const p=document.createElement("span");p.className="key-cap",p.textContent=`${t.key.inc.toUpperCase()}/${t.key.dec.toUpperCase()}`,o.appendChild(p)}const r=document.createElement("div");r.className="control-inputs";const l=document.createElement("input");l.type="range",l.min=String(t.min??0),l.max=String(t.max??1),l.step=String(t.step??(t.type==="int"?1:.01)),l.value=String(oe[e.id][t.id]),l.addEventListener("input",p=>{const y=Number(p.target.value);Number.isNaN(y)||he(e.id,t.id,y)});const u=document.createElement("input");u.type="number",u.min=l.min,u.max=l.max,u.step=l.step,u.value=nn(t,oe[e.id][t.id]),u.addEventListener("input",p=>{const y=Number(p.target.value);Number.isNaN(y)||he(e.id,t.id,y)}),r.appendChild(l),r.appendChild(u),n.appendChild(o),n.appendChild(r),nt.appendChild(n),ot[t.id]={range:l,number:u}}}function mo(e){le.innerHTML="";for(const t of e.params){if(!t.key||t.type==="seed")continue;const n=document.createElement("div");n.className="key-row",n.textContent=`${t.key.inc.toUpperCase()}/${t.key.dec.toUpperCase()}  ${t.label}`,le.appendChild(n)}le.childElementCount||(le.textContent="No mapped keys for this scene.")}function on(e){const t=ve.find(n=>n.id===e);t&&(O=t,t.stateful&&(bt(t),de(t.id)),Ue.textContent=t.name,Yt.textContent=t.description,no(),fo(t),co(t),mo(t),ee.value=t.id)}function po(e){if(ro(e.target))return;const t=ao(e.key),n=O.params;for(const o of n){if(!o.key||o.type==="seed")continue;const a=t===o.key.inc,r=t===o.key.dec;if(!a&&!r)continue;const l=e.shiftKey&&o.key.shiftStep?o.key.shiftStep:o.key.step,p=oe[O.id][o.id]+l*(a?1:-1);he(O.id,o.id,p),e.preventDefault();break}}function Ce(e,t,n,o,a){const r=oe[e.id],l=t.uniforms,u=l[e.resolutionUniform];u&&s.uniform2f(u,o,a);const p=l[e.timeUniform];if(p)if(e.timeMode==="phase"){const g=e.loopDuration??8,w=n%g/g;s.uniform1f(p,w)}else if(e.timeMode==="looped"){const g=e.loopDuration??8,w=n%g;if(s.uniform1f(p,w),e.loopUniform){const S=l[e.loopUniform];S&&s.uniform1f(S,g)}}else s.uniform1f(p,n);const y={};for(const g of e.params){const w=l[g.uniform],S=r[g.id];if(g.component!==void 0){const W=y[g.uniform]??[0,0,0];W[g.component]=S,y[g.uniform]=W;continue}w&&(g.type==="int"?s.uniform1i(w,Math.round(S)):s.uniform1f(w,S))}for(const[g,w]of Object.entries(y)){const S=l[g];S&&s.uniform3f(S,w[0],w[1],w[2])}}function je(e,t,n,o){const a=t.uniforms[e.passUniform??"uPass"];a&&s.uniform1i(a,o);const r=t.uniforms[e.gridUniform??"uGridSize"];r&&s.uniform2f(r,n.size,n.size);const l=t.uniforms[e.stateUniform??"uState"];l&&s.uniform1i(l,0)}function an(e,t,n,o){const a=Zt.get(e.id);if(a){if(e.stateful){if(!Xi)return;const r=bt(e);if(!r)return;const l=()=>r.textures[r.index],u=()=>r.fbos[(r.index+1)%2];s.useProgram(a.program),s.bindVertexArray(Bt),r.needsInit&&(s.bindFramebuffer(s.FRAMEBUFFER,u()),s.viewport(0,0,r.size,r.size),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,l()),Ce(e,a,t,n,o),je(e,a,r,2),s.drawArrays(s.TRIANGLES,0,3),r.index=(r.index+1)%2,r.needsInit=!1),s.bindFramebuffer(s.FRAMEBUFFER,u()),s.viewport(0,0,r.size,r.size),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,l()),Ce(e,a,t,n,o),je(e,a,r,0),s.drawArrays(s.TRIANGLES,0,3),r.index=(r.index+1)%2,s.bindFramebuffer(s.FRAMEBUFFER,null),s.viewport(0,0,n,o),s.clearColor(0,0,0,1),s.clear(s.COLOR_BUFFER_BIT),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,l()),Ce(e,a,t,n,o),je(e,a,r,1),s.drawArrays(s.TRIANGLES,0,3);return}s.viewport(0,0,n,o),s.clearColor(0,0,0,1),s.clear(s.COLOR_BUFFER_BIT),s.useProgram(a.program),s.bindVertexArray(Bt),Ce(e,a,t,n,o),s.drawArrays(s.TRIANGLES,0,3)}}function St(e){if(Ge)return;const t=(e-gt)/1e3,{width:n,height:o}=Un(k);an(O,t,n,o),requestAnimationFrame(St)}function ho(){return new Promise(e=>requestAnimationFrame(()=>e()))}async function vo(e,t,n,o,a){if(typeof VideoEncoder>"u"||typeof VideoFrame>"u"){alert("Offline rendering requires the WebCodecs API (Chrome/Edge 94+, Safari 16.4+).");return}const r={codec:"avc1.640028",width:o,height:a,bitrate:16e6,framerate:n};if(!(await VideoEncoder.isConfigSupported(r)).supported){alert("H.264 video encoding is not supported on this device.");return}let u;try{u=await window.showSaveFilePicker({suggestedName:`${e.id}-${o}x${a}-${n}fps-${t}s.mp4`,types:[{description:"MP4 Video",accept:{"video/mp4":[".mp4"]}}]})}catch{return}const p=await u.createWritable(),y=document.getElementById("offline-btn"),g=document.getElementById("offline-progress"),w=document.getElementById("offline-bar"),S=document.getElementById("offline-status");y&&(y.disabled=!0),g==null||g.classList.remove("hidden"),S==null||S.classList.remove("hidden"),Ge=!0,e.stateful&&(bt(e),de(e.id));const W=k.width,G=k.height,D=k.style.width,Z=k.style.height;k.width=o,k.height=a,k.style.width=`${o}px`,k.style.height=`${a}px`;const rn=new Gt(p),xt=new Vi({target:rn,video:{codec:"avc",width:o,height:a},fastStart:!1});let be=null;const K=new VideoEncoder({output:(C,We)=>xt.addVideoChunk(C,We??void 0),error:C=>{be=C}});K.configure(r);const Se=Math.ceil(t*n),wt=Math.round(1e6/n),ln=n*2,sn=n*30,un=performance.now();let xe=!1;const Ct=C=>{C.preventDefault(),xe=!0};k.addEventListener("webglcontextlost",Ct);for(let C=0;C<Se&&!(be||xe);C++){const We=C/n;an(e,We,o,a),s.finish();const Tt=new VideoFrame(k,{timestamp:C*wt,duration:wt});K.encode(Tt,{keyFrame:C%ln===0}),Tt.close(),C>0&&C%sn===0&&await K.flush();const fn=(C+1)/Se*100;if(w&&(w.style.width=`${fn}%`),C%30===0){const cn=(performance.now()-un)/1e3/(C+1)*(Se-C-1);S&&(S.textContent=`Frame ${C+1}/${Se}  —  ~${Math.ceil(cn)}s left`)}K.encodeQueueSize>10&&await new Promise(kt=>setTimeout(kt,1)),await ho()}k.removeEventListener("webglcontextlost",Ct);try{await K.flush(),K.close(),xt.finalize(),await p.close()}catch(C){console.error("Finalization failed:",C);try{await p.close()}catch{}}k.style.width=D,k.style.height=Z,k.width=W,k.height=G,e.stateful&&de(e.id),Ge=!1,gt=performance.now(),requestAnimationFrame(St),y&&(y.disabled=!1);const Oe=be?be.message:null;S&&(xe?S.textContent="Context lost — partial video saved.":Oe?S.textContent=`Error: ${Oe}`:S.textContent="Done!"),setTimeout(()=>{g==null||g.classList.add("hidden"),S==null||S.classList.add("hidden"),w&&(w.style.width="0%")},xe||!!Oe?8e3:3e3)}Le.addEventListener("click",()=>{document.body.classList.toggle("sidebar-collapsed"),tn()});yt.addEventListener("mousemove",()=>{to()});document.addEventListener("keydown",po);document.addEventListener("visibilitychange",()=>{document.hidden||(gt=performance.now())});var zt;(zt=document.getElementById("rec-btn"))==null||zt.addEventListener("click",eo);var It;(It=document.getElementById("offline-btn"))==null||It.addEventListener("click",()=>{if(Ge)return;const e=document.getElementById("offline-duration"),t=document.getElementById("offline-fps"),n=document.getElementById("offline-res"),o=Math.max(1,Math.min(3600,Number((e==null?void 0:e.value)??10))),a=Number((t==null?void 0:t.value)??60),[r,l]=((n==null?void 0:n.value)??"1920x1080").split("x").map(Number);vo(O,o,a,r,l)});uo();on(O.id);tn();at(!0);requestAnimationFrame(St);
