...
`;const k=document.querySelector("#gl-canvas"),ee=document.querySelector("#scene-list"),nt=document.querySelector("#control-list"),Fe=document.querySelector("#panel-actions"),le=document.querySelector("#key-help"),Ge=document.querySelector("#hud-title"),Yt=document.querySelector("#hud-desc"),Le=document.querySelector("[data-action='toggle-sidebar']"),yt=document.querySelector(".stage");if(!k||!ee||!nt||!Fe||!le||!Ge||!Yt||!Le||!yt)throw new Error("Missing required UI elements");const s=k.getContext("webgl2",{antialias:!0});if(!s)throw yt.innerHTML=`
    <div class="fallback">
      <h2>WebGL2 unavailable</h2>
      <p>Your browser or GPU does not expose WebGL2. Try a different browser.</p>
    </div>
  `,new Error("WebGL2 unavailable");const Vi=s.getExtension("EXT_color_buffer_float"),ji=!!Vi;s.disable(s.DEPTH_TEST);s.disable(s.BLEND);const Bt=Gn(s),Zt=new Map,Kt={},ae={},Qt={},it=new Map;for(const e of ve){const t=En(s,mn,e.fragment),n=new Set;n.add(e.resolutionUniform),n.add(e.timeUniform),e.loopUniform&&n.add(e.loopUniform),e.stateful&&(n.add(e.passUniform??"uPass"),n.add(e.stateUniform??"uState"),n.add(e.gridUniform??"uGridSize"));for(const l of e.params)n.add(l.uniform);const a=Pn(s,t,Array.from(n));Zt.set(e.id,{program:t,uniforms:a});const o={},r={};for(const l of e.params)o[l.id]=l,r[l.id]=l.type==="seed"?Math.floor(Math.random()*1e6):l.value;Kt[e.id]=o,ae[e.id]={...r},Qt[e.id]={...r}}let O=ve[0],at={},gt=performance.now(),qe=null,Ve=null,X=null,we=[],Jt=0,ze=null,ge=!1;function Xi(){const e=["video/webm;codecs=vp9","video/webm;codecs=vp8","video/webm","video/mp4"];for(const t of e)if(MediaRecorder.isTypeSupported(t))return t;return""}function $i(e){return e.startsWith("video/mp4")?"mp4":"webm"}function Yi(e){const t=Math.floor(e/1e3),n=String(Math.floor(t/60)).padStart(2,"0"),a=String(t%60).padStart(2,"0");return`${n}:${a}`}function Zi(){const e=document.getElementById("rec-badge");!e||!ge||(e.textContent=`⏺ ${Yi(performance.now()-Jt)}`)}function Ki(){const e=Xi();if(!e){alert("Recording is not supported in this browser.");return}const t=k.captureStream(60);we=[],X=new MediaRecorder(t,{mimeType:e,videoBitsPerSecond:16e6}),X.ondataavailable=n=>{n.data.size>0&&we.push(n.data)},X.onstop=()=>{const n=$i(e),a=new Blob(we,{type:e}),o=URL.createObjectURL(a),r=document.createElement("a");r.href=o,r.download=`${O.id}-${Date.now()}.${n}`,r.click(),URL.revokeObjectURL(o),we=[]},X.start(500),ge=!0,Jt=performance.now(),en(),ze=window.setInterval(Zi,250)}function Qi(){X&&X.state!=="inactive"&&X.stop(),ge=!1,ze!==null&&(clearInterval(ze),ze=null),en()}function Ji(){ge?Qi():Ki()}function en(){const e=document.getElementById("rec-btn"),t=document.getElementById("rec-badge");!e||!t||(ge?(e.textContent="Stop",e.classList.add("recording"),t.classList.remove("hidden")):(e.textContent="Record",e.classList.remove("recording"),t.classList.add("hidden"),t.textContent=""))}let Ue=!1;function ot(e){Le.classList.toggle("hidden",e)}function ea(){ot(!1),Ve!==null&&window.clearTimeout(Ve),Ve=window.setTimeout(()=>{ot(!0)},2500)}function tn(){const e=document.body.classList.contains("sidebar-collapsed");Le.textContent=e?">>":"<<"}function ta(){var e;(e=Ge.parentElement)==null||e.classList.remove("hidden"),qe!==null&&window.clearTimeout(qe),qe=window.setTimeout(()=>{var t;(t=Ge.parentElement)==null||t.classList.add("hidden")},1e4)}function Ft(e){const t=s.createTexture();if(!t)throw new Error("Failed to create state texture");return s.bindTexture(s.TEXTURE_2D,t),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.REPEAT),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.REPEAT),s.texImage2D(s.TEXTURE_2D,0,s.RGBA16F,e,e,0,s.RGBA,s.HALF_FLOAT,null),s.bindTexture(s.TEXTURE_2D,null),t}function na(e){const t=Ft(e),n=Ft(e),a=s.createFramebuffer(),o=s.createFramebuffer();if(!a||!o)throw new Error("Failed to create framebuffer");return s.bindFramebuffer(s.FRAMEBUFFER,a),s.framebufferTexture2D(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,t,0),s.bindFramebuffer(s.FRAMEBUFFER,o),s.framebufferTexture2D(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,n,0),s.bindFramebuffer(s.FRAMEBUFFER,null),{size:e,textures:[t,n],fbos:[a,o],index:0,needsInit:!0}}function bt(e){if(!e.stateful)return null;let t=it.get(e.id);const n=e.bufferSize??192;return(!t||t.size!==n)&&(t=na(n),it.set(e.id,t)),t}function de(e){const t=it.get(e);t&&(t.needsInit=!0)}function ia(e,t){let n=t;return e.min!==void 0&&(n=Math.max(e.min,n)),e.max!==void 0&&(n=Math.min(e.max,n)),e.type==="int"&&(n=Math.round(n)),n}function nn(e,t){if(e.type==="int")return String(Math.round(t));const n=e.step??.01,a=n<1?Math.min(4,Math.max(2,Math.ceil(-Math.log10(n)))):0;return t.toFixed(a)}function aa(e){return e.length===1?e.toLowerCase():e}function oa(e){return e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement||e instanceof HTMLSelectElement}function he(e,t,n,a=!0){const o=Kt[e][t];if(!o)return;const r=ia(o,n);if(ae[e][t]=r,e===O.id&&a){const l=at[t];l!=null&&l.range&&(l.range.value=String(r)),l!=null&&l.number&&(l.number.value=nn(o,r))}}function ra(e){var t;for(const n of((t=ve.find(a=>a.id===e))==null?void 0:t.params)??[])n.type==="seed"&&he(e,n.id,Math.floor(Math.random()*1e6));de(e)}function la(e){const t=Qt[e];for(const[n,a]of Object.entries(t))he(e,n,a,!0);de(e)}function sa(){ee.innerHTML="";for(const e of ve){const t=document.createElement("option");t.value=e.id,t.textContent=e.name,ee.appendChild(t)}ee.addEventListener("change",()=>{an(ee.value)})}function ua(e){Fe.innerHTML="";const t=document.createElement("button");if(t.className="ghost small",t.textContent="Reset",t.addEventListener("click",()=>la(e.id)),Fe.appendChild(t),e.params.some(a=>a.type==="seed")){const a=document.createElement("button");a.className="ghost small",a.textContent="Reseed",a.addEventListener("click",()=>ra(e.id)),Fe.appendChild(a)}}function fa(e){nt.innerHTML="",at={};for(const t of e.params){if(t.type==="seed")continue;const n=document.createElement("div");n.className="control";const a=document.createElement("div");a.className="control-header";const o=document.createElement("label");if(o.textContent=t.label,a.appendChild(o),t.key){const p=document.createElement("span");p.className="key-cap",p.textContent=`${t.key.inc.toUpperCase()}/${t.key.dec.toUpperCase()}`,a.appendChild(p)}const r=document.createElement("div");r.className="control-inputs";const l=document.createElement("input");l.type="range",l.min=String(t.min??0),l.max=String(t.max??1),l.step=String(t.step??(t.type==="int"?1:.01)),l.value=String(ae[e.id][t.id]),l.addEventListener("input",p=>{const y=Number(p.target.value);Number.isNaN(y)||he(e.id,t.id,y)});const u=document.createElement("input");u.type="number",u.min=l.min,u.max=l.max,u.step=l.step,u.value=nn(t,ae[e.id][t.id]),u.addEventListener("input",p=>{const y=Number(p.target.value);Number.isNaN(y)||he(e.id,t.id,y)}),r.appendChild(l),r.appendChild(u),n.appendChild(a),n.appendChild(r),nt.appendChild(n),at[t.id]={range:l,number:u}}}function ca(e){le.innerHTML="";for(const t of e.params){if(!t.key||t.type==="seed")continue;const n=document.createElement("div");n.className="key-row",n.textContent=`${t.key.inc.toUpperCase()}/${t.key.dec.toUpperCase()}  ${t.label}`,le.appendChild(n)}le.childElementCount||(le.textContent="No mapped keys for this scene.")}function an(e){const t=ve.find(n=>n.id===e);t&&(O=t,t.stateful&&(bt(t),de(t.id)),Ge.textContent=t.name,Yt.textContent=t.description,ta(),ua(t),fa(t),ca(t),ee.value=t.id)}function ma(e){if(oa(e.target))return;const t=aa(e.key),n=O.params;for(const a of n){if(!a.key||a.type==="seed")continue;const o=t===a.key.inc,r=t===a.key.dec;if(!o&&!r)continue;const l=e.shiftKey&&a.key.shiftStep?a.key.shiftStep:a.key.step,p=ae[O.id][a.id]+l*(o?1:-1);he(O.id,a.id,p),e.preventDefault();break}}function Ce(e,t,n,a,o){const r=ae[e.id],l=t.uniforms,u=l[e.resolutionUniform];u&&s.uniform2f(u,a,o);const p=l[e.timeUniform];if(p)if(e.timeMode==="phase"){const g=e.loopDuration??8,w=n%g/g;s.uniform1f(p,w)}else if(e.timeMode==="looped"){const g=e.loopDuration??8,w=n%g;if(s.uniform1f(p,w),e.loopUniform){const S=l[e.loopUniform];S&&s.uniform1f(S,g)}}else s.uniform1f(p,n);const y={};for(const g of e.params){const w=l[g.uniform],S=r[g.id];if(g.component!==void 0){const W=y[g.uniform]??[0,0,0];W[g.component]=S,y[g.uniform]=W;continue}w&&(g.type==="int"?s.uniform1i(w,Math.round(S)):s.uniform1f(w,S))}for(const[g,w]of Object.entries(y)){const S=l[g];S&&s.uniform3f(S,w[0],w[1],w[2])}}function je(e,t,n,a){const o=t.uniforms[e.passUniform??"uPass"];o&&s.uniform1i(o,a);const r=t.uniforms[e.gridUniform??"uGridSize"];r&&s.uniform2f(r,n.size,n.size);const l=t.uniforms[e.stateUniform??"uState"];l&&s.uniform1i(l,0)}function on(e,t,n,a){const o=Zt.get(e.id);if(o){if(e.stateful){if(!ji)return;const r=bt(e);if(!r)return;const l=()=>r.textures[r.index],u=()=>r.fbos[(r.index+1)%2];s.useProgram(o.program),s.bindVertexArray(Bt),r.needsInit&&(s.bindFramebuffer(s.FRAMEBUFFER,u()),s.viewport(0,0,r.size,r.size),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,l()),Ce(e,o,t,n,a),je(e,o,r,2),s.drawArrays(s.TRIANGLES,0,3),r.index=(r.index+1)%2,r.needsInit=!1),s.bindFramebuffer(s.FRAMEBUFFER,u()),s.viewport(0,0,r.size,r.size),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,l()),Ce(e,o,t,n,a),je(e,o,r,0),s.drawArrays(s.TRIANGLES,0,3),r.index=(r.index+1)%2,s.bindFramebuffer(s.FRAMEBUFFER,null),s.viewport(0,0,n,a),s.clearColor(0,0,0,1),s.clear(s.COLOR_BUFFER_BIT),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,l()),Ce(e,o,t,n,a),je(e,o,r,1),s.drawArrays(s.TRIANGLES,0,3);return}s.viewport(0,0,n,a),s.clearColor(0,0,0,1),s.clear(s.COLOR_BUFFER_BIT),s.useProgram(o.program),s.bindVertexArray(Bt),Ce(e,o,t,n,a),s.drawArrays(s.TRIANGLES,0,3)}}function St(e){if(Ue)return;const t=(e-gt)/1e3,{width:n,height:a}=Nn(k);on(O,t,n,a),requestAnimationFrame(St)}function pa(){return new Promise(e=>requestAnimationFrame(()=>e()))}async function da(e,t,n,a,o){if(typeof VideoEncoder>"u"||typeof VideoFrame>"u"){alert("Offline rendering requires the WebCodecs API (Chrome/Edge 94+, Safari 16.4+).");return}const r={codec:"avc1.640028",width:a,height:o,bitrate:16e6,framerate:n};if(!(await VideoEncoder.isConfigSupported(r)).supported){alert("H.264 video encoding is not supported on this device.");return}let u;try{u=await window.showSaveFilePicker({suggestedName:`${e.id}-${a}x${o}-${n}fps-${t}s.mp4`,types:[{description:"MP4 Video",accept:{"video/mp4":[".mp4"]}}]})}catch{return}const p=await u.createWritable(),y=document.getElementById("offline-btn"),g=document.getElementById("offline-progress"),w=document.getElementById("offline-bar"),S=document.getElementById("offline-status");y&&(y.disabled=!0),g==null||g.classList.remove("hidden"),S==null||S.classList.remove("hidden"),Ue=!0,e.stateful&&(bt(e),de(e.id));const W=k.width,U=k.height,D=k.style.width,Z=k.style.height;k.width=a,k.height=o,k.style.width=`${a}px`,k.style.height=`${o}px`;const rn=new Ut(p),xt=new qi({target:rn,video:{codec:"avc",width:a,height:o},fastStart:!1});let be=null;const K=new VideoEncoder({output:(C,We)=>xt.addVideoChunk(C,We??void 0),error:C=>{be=C}});K.configure(r);const Se=Math.ceil(t*n),wt=Math.round(1e6/n),ln=n*2,sn=n*30,un=performance.now();let xe=!1;const Ct=C=>{C.preventDefault(),xe=!0};k.addEventListener("webglcontextlost",Ct);for(let C=0;C<Se&&!(be||xe);C++){const We=C/n;on(e,We,a,o),s.finish();const Tt=new VideoFrame(k,{timestamp:C*wt,duration:wt});K.encode(Tt,{keyFrame:C%ln===0}),Tt.close(),C>0&&C%sn===0&&await K.flush();const fn=(C+1)/Se*100;if(w&&(w.style.width=`${fn}%`),C%30===0){const cn=(performance.now()-un)/1e3/(C+1)*(Se-C-1);S&&(S.textContent=`Frame ${C+1}/${Se}  —  ~${Math.ceil(cn)}s left`)}K.encodeQueueSize>10&&await new Promise(kt=>setTimeout(kt,1)),await pa()}k.removeEventListener("webglcontextlost",Ct);try{await K.flush(),K.close(),xt.finalize(),await p.close()}catch(C){console.error("Finalization failed:",C);try{await p.close()}catch{}}k.style.width=D,k.style.height=Z,k.width=W,k.height=U,e.stateful&&de(e.id),Ue=!1,gt=performance.now(),requestAnimationFrame(St),y&&(y.disabled=!1);const Oe=be?be.message:null;S&&(xe?S.textContent="Context lost — partial video saved.":Oe?S.textContent=`Error: ${Oe}`:S.textContent="Done!"),setTimeout(()=>{g==null||g.classList.add("hidden"),S==null||S.classList.add("hidden"),w&&(w.style.width="0%")},xe||!!Oe?8e3:3e3)}Le.addEventListener("click",()=>{document.body.classList.toggle("sidebar-collapsed"),tn()});yt.addEventListener("mousemove",()=>{ea()});document.addEventListener("keydown",ma);document.addEventListener("visibilitychange",()=>{document.hidden||(gt=performance.now())});var zt;(zt=document.getElementById("rec-btn"))==null||zt.addEventListener("click",Ji);var It;(It=document.getElementById("offline-btn"))==null||It.addEventListener("click",()=>{if(Ue)return;const e=document.getElementById("offline-duration"),t=document.getElementById("offline-fps"),n=document.getElementById("offline-res"),a=Math.max(1,Math.min(3600,Number((e==null?void 0:e.value)??10))),o=Number((t==null?void 0:t.value)??60),[r,l]=((n==null?void 0:n.value)??"1920x1080").split("x").map(Number);da(O,a,o,r,l)});sa();an(O.id);tn();ot(!0);requestAnimationFrame(St);
