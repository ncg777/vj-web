...
`;const k=document.querySelector("#gl-canvas"),ee=document.querySelector("#scene-list"),nt=document.querySelector("#control-list"),Fe=document.querySelector("#panel-actions"),se=document.querySelector("#key-help"),Ge=document.querySelector("#hud-title"),$t=document.querySelector("#hud-desc"),Ne=document.querySelector("[data-action='toggle-sidebar']"),yt=document.querySelector(".stage");if(!k||!ee||!nt||!Fe||!se||!Ge||!$t||!Ne||!yt)throw new Error("Missing required UI elements");const s=k.getContext("webgl2",{antialias:!0});if(!s)throw yt.innerHTML=`
    <div class="fallback">
      <h2>WebGL2 unavailable</h2>
      <p>Your browser or GPU does not expose WebGL2. Try a different browser.</p>
    </div>
  `,new Error("WebGL2 unavailable");const Xi=s.getExtension("EXT_color_buffer_float"),Yi=!!Xi;s.disable(s.DEPTH_TEST);s.disable(s.BLEND);const Bt=_n(s),Zt=new Map,Kt={},ae={},Qt={},it=new Map;for(const e of oe){const t=Ln(s,cn,e.fragment),n=new Set;n.add(e.resolutionUniform),n.add(e.timeUniform),e.loopUniform&&n.add(e.loopUniform),e.stateful&&(n.add(e.passUniform??"uPass"),n.add(e.stateUniform??"uState"),n.add(e.gridUniform??"uGridSize"));for(const r of e.params)n.add(r.uniform);const a=Gn(s,t,Array.from(n));Zt.set(e.id,{program:t,uniforms:a});const o={},l={};for(const r of e.params)o[r.id]=r,l[r.id]=r.type==="seed"?Math.floor(Math.random()*1e6):r.value;Kt[e.id]=o,ae[e.id]={...l},Qt[e.id]={...l}}let W=oe[0],at={},bt=performance.now(),He=null,Ve=null,X=null,we=[],Jt=0,Me=null,be=!1;function $i(){const e=["video/webm;codecs=vp9","video/webm;codecs=vp8","video/webm","video/mp4"];for(const t of e)if(MediaRecorder.isTypeSupported(t))return t;return""}function Zi(e){return e.startsWith("video/mp4")?"mp4":"webm"}function Ki(e){const t=Math.floor(e/1e3),n=String(Math.floor(t/60)).padStart(2,"0"),a=String(t%60).padStart(2,"0");return`${n}:${a}`}function Qi(){const e=document.getElementById("rec-badge");!e||!be||(e.textContent=`⏺ ${Ki(performance.now()-Jt)}`)}function Ji(){const e=$i();if(!e){alert("Recording is not supported in this browser.");return}const t=k.captureStream(60);we=[],X=new MediaRecorder(t,{mimeType:e,videoBitsPerSecond:16e6}),X.ondataavailable=n=>{n.data.size>0&&we.push(n.data)},X.onstop=()=>{const n=Zi(e),a=new Blob(we,{type:e}),o=URL.createObjectURL(a),l=document.createElement("a");l.href=o,l.download=`${W.id}-${Date.now()}.${n}`,l.click(),URL.revokeObjectURL(o),we=[]},X.start(500),be=!0,Jt=performance.now(),en(),Me=window.setInterval(Qi,250)}function ea(){X&&X.state!=="inactive"&&X.stop(),be=!1,Me!==null&&(clearInterval(Me),Me=null),en()}function ta(){be?ea():Ji()}function en(){const e=document.getElementById("rec-btn"),t=document.getElementById("rec-badge");!e||!t||(be?(e.textContent="Stop",e.classList.add("recording"),t.classList.remove("hidden")):(e.textContent="Record",e.classList.remove("recording"),t.classList.add("hidden"),t.textContent=""))}let Ue=!1;function ot(e){Ne.classList.toggle("hidden",e)}function na(){ot(!1),Ve!==null&&window.clearTimeout(Ve),Ve=window.setTimeout(()=>{ot(!0)},2500)}function tn(){const e=document.body.classList.contains("sidebar-collapsed");Ne.textContent=e?">>":"<<"}function ia(){var e;(e=Ge.parentElement)==null||e.classList.remove("hidden"),He!==null&&window.clearTimeout(He),He=window.setTimeout(()=>{var t;(t=Ge.parentElement)==null||t.classList.add("hidden")},1e4)}function Ft(e){const t=s.createTexture();if(!t)throw new Error("Failed to create state texture");return s.bindTexture(s.TEXTURE_2D,t),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.REPEAT),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.REPEAT),s.texImage2D(s.TEXTURE_2D,0,s.RGBA16F,e,e,0,s.RGBA,s.HALF_FLOAT,null),s.bindTexture(s.TEXTURE_2D,null),t}function aa(e){const t=Ft(e),n=Ft(e),a=s.createFramebuffer(),o=s.createFramebuffer();if(!a||!o)throw new Error("Failed to create framebuffer");return s.bindFramebuffer(s.FRAMEBUFFER,a),s.framebufferTexture2D(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,t,0),s.bindFramebuffer(s.FRAMEBUFFER,o),s.framebufferTexture2D(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,n,0),s.bindFramebuffer(s.FRAMEBUFFER,null),{size:e,textures:[t,n],fbos:[a,o],index:0,needsInit:!0}}function St(e){if(!e.stateful)return null;let t=it.get(e.id);const n=e.bufferSize??192;return(!t||t.size!==n)&&(t=aa(n),it.set(e.id,t)),t}function he(e){const t=it.get(e);t&&(t.needsInit=!0)}function oa(e,t){let n=t;return e.min!==void 0&&(n=Math.max(e.min,n)),e.max!==void 0&&(n=Math.min(e.max,n)),e.type==="int"&&(n=Math.round(n)),n}function nn(e,t){if(e.type==="int")return String(Math.round(t));const n=e.step??.01,a=n<1?Math.min(4,Math.max(2,Math.ceil(-Math.log10(n)))):0;return t.toFixed(a)}function la(e){return e.length===1?e.toLowerCase():e}function ra(e){return e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement||e instanceof HTMLSelectElement}function ve(e,t,n,a=!0){const o=Kt[e][t];if(!o)return;const l=oa(o,n);if(ae[e][t]=l,e===W.id&&a){const r=at[t];r!=null&&r.range&&(r.range.value=String(l)),r!=null&&r.number&&(r.number.value=nn(o,l))}}function sa(e){var t;for(const n of((t=oe.find(a=>a.id===e))==null?void 0:t.params)??[])n.type==="seed"&&ve(e,n.id,Math.floor(Math.random()*1e6));he(e)}function ua(e){const t=Qt[e];for(const[n,a]of Object.entries(t))ve(e,n,a,!0);he(e)}function fa(){ee.innerHTML="";for(const e of oe){const t=document.createElement("option");t.value=e.id,t.textContent=e.name,ee.appendChild(t)}ee.addEventListener("change",()=>{an(ee.value)})}function ma(e){Fe.innerHTML="";const t=document.createElement("button");if(t.className="ghost small",t.textContent="Reset",t.addEventListener("click",()=>ua(e.id)),Fe.appendChild(t),e.params.some(a=>a.type==="seed")){const a=document.createElement("button");a.className="ghost small",a.textContent="Reseed",a.addEventListener("click",()=>sa(e.id)),Fe.appendChild(a)}}function ca(e){nt.innerHTML="",at={};for(const t of e.params){if(t.type==="seed")continue;const n=document.createElement("div");n.className="control";const a=document.createElement("div");a.className="control-header";const o=document.createElement("label");if(o.textContent=t.label,a.appendChild(o),t.key){const p=document.createElement("span");p.className="key-cap",p.textContent=`${t.key.inc.toUpperCase()}/${t.key.dec.toUpperCase()}`,a.appendChild(p)}const l=document.createElement("div");l.className="control-inputs";const r=document.createElement("input");r.type="range",r.min=String(t.min??0),r.max=String(t.max??1),r.step=String(t.step??(t.type==="int"?1:.01)),r.value=String(ae[e.id][t.id]),r.addEventListener("input",p=>{const y=Number(p.target.value);Number.isNaN(y)||ve(e.id,t.id,y)});const u=document.createElement("input");u.type="number",u.min=r.min,u.max=r.max,u.step=r.step,u.value=nn(t,ae[e.id][t.id]),u.addEventListener("input",p=>{const y=Number(p.target.value);Number.isNaN(y)||ve(e.id,t.id,y)}),l.appendChild(r),l.appendChild(u),n.appendChild(a),n.appendChild(l),nt.appendChild(n),at[t.id]={range:r,number:u}}}function pa(e){se.innerHTML="";for(const t of e.params){if(!t.key||t.type==="seed")continue;const n=document.createElement("div");n.className="key-row",n.textContent=`${t.key.inc.toUpperCase()}/${t.key.dec.toUpperCase()}  ${t.label}`,se.appendChild(n)}se.childElementCount||(se.textContent="No mapped keys for this scene.")}function an(e){const t=oe.find(n=>n.id===e);t&&(W=t,t.stateful&&(St(t),he(t.id)),Ge.textContent=t.name,$t.textContent=t.description,ia(),ma(t),ca(t),pa(t),ee.value=t.id)}function da(e){if(ra(e.target))return;const t=la(e.key),n=W.params;for(const a of n){if(!a.key||a.type==="seed")continue;const o=t===a.key.inc,l=t===a.key.dec;if(!o&&!l)continue;const r=e.shiftKey&&a.key.shiftStep?a.key.shiftStep:a.key.step,p=ae[W.id][a.id]+r*(o?1:-1);ve(W.id,a.id,p),e.preventDefault();break}}function Te(e,t,n,a,o){const l=ae[e.id],r=t.uniforms,u=r[e.resolutionUniform];u&&s.uniform2f(u,a,o);const p=r[e.timeUniform];if(p)if(e.timeMode==="phase"){const b=e.loopDuration??8,w=n%b/b;s.uniform1f(p,w)}else if(e.timeMode==="looped"){const b=e.loopDuration??8,w=n%b;if(s.uniform1f(p,w),e.loopUniform){const g=r[e.loopUniform];g&&s.uniform1f(g,b)}}else s.uniform1f(p,n);const y={};for(const b of e.params){const w=r[b.uniform],g=l[b.id];if(b.component!==void 0){const O=y[b.uniform]??[0,0,0];O[b.component]=g,y[b.uniform]=O;continue}w&&(b.type==="int"?s.uniform1i(w,Math.round(g)):s.uniform1f(w,g))}for(const[b,w]of Object.entries(y)){const g=r[b];g&&s.uniform3f(g,w[0],w[1],w[2])}}function je(e,t,n,a){const o=t.uniforms[e.passUniform??"uPass"];o&&s.uniform1i(o,a);const l=t.uniforms[e.gridUniform??"uGridSize"];l&&s.uniform2f(l,n.size,n.size);const r=t.uniforms[e.stateUniform??"uState"];r&&s.uniform1i(r,0)}function on(e,t,n,a){const o=Zt.get(e.id);if(o){if(e.stateful){if(!Yi)return;const l=St(e);if(!l)return;const r=()=>l.textures[l.index],u=()=>l.fbos[(l.index+1)%2];s.useProgram(o.program),s.bindVertexArray(Bt),l.needsInit&&(s.bindFramebuffer(s.FRAMEBUFFER,u()),s.viewport(0,0,l.size,l.size),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,r()),Te(e,o,t,n,a),je(e,o,l,2),s.drawArrays(s.TRIANGLES,0,3),l.index=(l.index+1)%2,l.needsInit=!1),s.bindFramebuffer(s.FRAMEBUFFER,u()),s.viewport(0,0,l.size,l.size),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,r()),Te(e,o,t,n,a),je(e,o,l,0),s.drawArrays(s.TRIANGLES,0,3),l.index=(l.index+1)%2,s.bindFramebuffer(s.FRAMEBUFFER,null),s.viewport(0,0,n,a),s.clearColor(0,0,0,1),s.clear(s.COLOR_BUFFER_BIT),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,r()),Te(e,o,t,n,a),je(e,o,l,1),s.drawArrays(s.TRIANGLES,0,3);return}s.viewport(0,0,n,a),s.clearColor(0,0,0,1),s.clear(s.COLOR_BUFFER_BIT),s.useProgram(o.program),s.bindVertexArray(Bt),Te(e,o,t,n,a),s.drawArrays(s.TRIANGLES,0,3)}}function gt(e){if(Ue)return;const t=(e-bt)/1e3,{width:n,height:a}=Un(k);on(W,t,n,a),requestAnimationFrame(gt)}function ha(){return new Promise(e=>requestAnimationFrame(()=>e()))}async function va(e,t,n,a,o){if(typeof VideoEncoder>"u"||typeof VideoFrame>"u"){alert("Offline rendering requires the WebCodecs API (Chrome/Edge 94+, Safari 16.4+).");return}const l={codec:"avc1.640028",width:a,height:o,bitrate:16e6,framerate:n};if(!(await VideoEncoder.isConfigSupported(l)).supported){alert("H.264 video encoding is not supported on this device.");return}let u;try{u=await window.showSaveFilePicker({suggestedName:`${e.id}-${a}x${o}-${n}fps-${t}s.mp4`,types:[{description:"MP4 Video",accept:{"video/mp4":[".mp4"]}}]})}catch{return}const p=await u.createWritable(),y=document.getElementById("offline-btn"),b=document.getElementById("offline-progress"),w=document.getElementById("offline-bar"),g=document.getElementById("offline-status");y&&(y.disabled=!0),b==null||b.classList.remove("hidden"),g==null||g.classList.remove("hidden"),Ue=!0,e.stateful&&(St(e),he(e.id));const O=k.width,U=k.height,P=k.style.width,Z=k.style.height;k.width=a,k.height=o,k.style.width=`${a}px`,k.style.height=`${o}px`;const ln=new Ut(p),xt=new ji({target:ln,video:{codec:"avc",width:a,height:o},fastStart:!1});let Se=null;const K=new VideoEncoder({output:(T,Oe)=>xt.addVideoChunk(T,Oe??void 0),error:T=>{Se=T}});K.configure(l);const ge=Math.ceil(t*n),wt=Math.round(1e6/n),rn=n*2,sn=n*30,un=performance.now();let xe=!1;const Tt=T=>{T.preventDefault(),xe=!0};k.addEventListener("webglcontextlost",Tt);for(let T=0;T<ge&&!(Se||xe);T++){const Oe=T/n;on(e,Oe,a,o),s.finish();const Ct=new VideoFrame(k,{timestamp:T*wt,duration:wt});K.encode(Ct,{keyFrame:T%rn===0}),Ct.close(),T>0&&T%sn===0&&await K.flush();const fn=(T+1)/ge*100;if(w&&(w.style.width=`${fn}%`),T%30===0){const mn=(performance.now()-un)/1e3/(T+1)*(ge-T-1);g&&(g.textContent=`Frame ${T+1}/${ge}  —  ~${Math.ceil(mn)}s left`)}K.encodeQueueSize>10&&await new Promise(kt=>setTimeout(kt,1)),await ha()}k.removeEventListener("webglcontextlost",Tt);try{await K.flush(),K.close(),xt.finalize(),await p.close()}catch(T){console.error("Finalization failed:",T);try{await p.close()}catch{}}k.style.width=P,k.style.height=Z,k.width=O,k.height=U,e.stateful&&he(e.id),Ue=!1,bt=performance.now(),requestAnimationFrame(gt),y&&(y.disabled=!1);const We=Se?Se.message:null;g&&(xe?g.textContent="Context lost — partial video saved.":We?g.textContent=`Error: ${We}`:g.textContent="Done!"),setTimeout(()=>{b==null||b.classList.add("hidden"),g==null||g.classList.add("hidden"),w&&(w.style.width="0%")},xe||!!We?8e3:3e3)}Ne.addEventListener("click",()=>{document.body.classList.toggle("sidebar-collapsed"),tn()});yt.addEventListener("mousemove",()=>{na()});document.addEventListener("keydown",da);document.addEventListener("visibilitychange",()=>{document.hidden||(bt=performance.now())});var Mt;(Mt=document.getElementById("rec-btn"))==null||Mt.addEventListener("click",ta);var It;(It=document.getElementById("offline-btn"))==null||It.addEventListener("click",()=>{if(Ue)return;const e=document.getElementById("offline-duration"),t=document.getElementById("offline-fps"),n=document.getElementById("offline-res"),a=Math.max(1,Math.min(3600,Number((e==null?void 0:e.value)??10))),o=Number((t==null?void 0:t.value)??60),[l,r]=((n==null?void 0:n.value)??"1920x1080").split("x").map(Number);va(W,a,o,l,r)});fa();an(W.id);tn();ot(!0);requestAnimationFrame(gt);
